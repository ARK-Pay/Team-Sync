...
const CreateCampaignModal = ({ isOpen, onClose, onSave, campaign, isEditing }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      const newCampaign = {
        ...
        // Note: We don't include the icon here as it will be added in the CampaignPage component
      };
  ...
  // This function is no longer needed here as icons are generated in the CampaignPage component
